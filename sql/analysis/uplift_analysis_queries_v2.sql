-- ============================================================
-- Personalized vs Static Uplift: Analysis Queries V2
-- ============================================================
-- VERSION 2: No crash exclusion - treats full v5.17 period as one
...
-- Users who received Personalized in BOTH periods
WITH user_period AS (
  SELECT
    user_id,
    period,
