...
- **Pipeline steps**: See `docs/architecture/pipeline_architecture.md` for data flow and validation points
- **Table schemas**: See `docs/architecture/bigquery_schema.md` for output table structure
